let products = document.getElementsByClassName('cook');
...
function view(classCook) {
    let elements = document.getElementsByClassName(classCook);
    let products = document.getElementsByClassName('cook');
    ...
    for (let e = 0; e < elements.length; e++){
        elements [e].style.display = ''; //ou list-item = block
    }
}
